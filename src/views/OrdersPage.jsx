      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-4">
        {kitchenOrders.map((order, index) => {
          ...
          return (
            <div
              key={index}
              className="border border-grey rounded-2xl px-4 py-5 flex flex-col divide-y divide-dashed"
            >
              <div className="flex items-center flex-col md:flex-row md:justify-between text-center gap-2 pb-2">
                <div className="flex items-center gap-2">
                  <div className="flex w-12 h-12 rounded-full items-center justify-center bg-gray-100 text-restro-green-light">
                    {table_id ? (
                  ...
                  <div className="py-2 bg-gray-50 px-2 mt-2 mb-2 rounded-xl">
                    <div className="flex items-center justify-between gap-2">
                      <div className="flex items-center justify-center flex-col text-center">
                        <p>Token:</p>
                        <div className="w-12 h-12 flex items-center justify-center font-bold rounded-full bg-restro-green-light text-white">
                          {token_no}
                        </div>
                      </div>
                          ...
                          >
                            ...
                            <div className="dropdown dropdown-left">
                              ...
                              >
                                ...
                                <li>
                                  <button
                                    className="flex items-center gap-2 bg-transparent border-none shadow-none text-success"
                                    onClick={() => {
                                      btnChangeOrderItemStatus(
                                        orderItemId,
                                        "completed"
