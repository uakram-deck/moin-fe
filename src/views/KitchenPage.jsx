      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-4">
        {kitchenOrders.map((order, index) => {
          ...
          return (
            <div
              key={index}
              className="border border-grey rounded-2xl px-4 py-5 flex flex-col"
            >
                  ...
                  return (
                    <div key={index} className="flex items-center gap-2 py-2">
                      ...
                      {status == "created" && (
                        <button
                          onClick={() => {
                            btnStartPreparingOrderItem(orderItemId);
                          }}
                      ...
                      {status == "preparing" && (
                        <button
                          onClick={() => {
                            btnCompletePreparingOrderItem(orderItemId);
                          }}
                          className="btn btn-sm"
                        >
                          Complete
