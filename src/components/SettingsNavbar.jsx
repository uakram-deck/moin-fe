      ...
      {items.map((item, index) => {
        return (
          <Link
            ...
            key={index}
            className={clsx(
              "w-12 h-12 md:w-full md:h-auto md:min-w-fit flex items-center justify-center md:justify-normal gap-1 md:px-4 md:py-3 rounded-full transition hover:bg-red-100 text-red-400",
              {
                "bg-restro-border-green-light text-restro-green-dark":
                  item.path == pathname,
              }
            )}
          >
