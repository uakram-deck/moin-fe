        ...
        <div className="modal-box">
          ...
          <div className="flex gap-4 w-full my-4">
            ...
            <div className="flex-1">
              ...
              <input ref={tableSeatingCapacityRef} type="number" name="capacity" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-restro-border-green-light" placeholder="Enter Seating Capcity" />
            </div>
          </div>
      ...
      <dialog id="modal-update" className="modal modal-bottom sm:modal-middle">
        <div className="modal-box">
          ...
          <div className="flex gap-4 w-full my-4">
            ...
            <div className="flex-1">
              <label htmlFor="capacity" className="mb-1 block text-gray-500 text-sm">Seating Capacity</label>
              <input ref={tableSeatingCapacityUpdateRef} type="number" name="capacity" className="text-sm w-full border rounded-lg px-4 py-2 bg-gray-50 outline-restro-border-green-light" placeholder="Enter Seating Capcity" />
            </div>
          </div>
